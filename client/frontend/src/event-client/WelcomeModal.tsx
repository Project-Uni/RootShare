...
function WelcomeModal(props: Props) {
            ...
            <DialogContent>
              <div style={{ maxHeight: 500, maxWidth: 500 }}>
                <RSText className={styles.messageText}>
                  Nicotine... I'm a fiend... Hittin' it... Since 17... Without it...
                  I'm so mean... Don't do drugs... You'll get addicted... But I
                  didn't listen... Now I need... NICOTINE YA YA YA... YA YA YA...
                  NICOTINE... YA YA YA... YA... YA... YA... GO OUT AND BUY A
                  MOTHAFUCKIN LYCHEE PUFF PLUS YAYAYAYAYA
                </RSText>
              </div>
            </DialogContent>
            <DialogActions>
  ...
  return <div className={styles.wrapper}>{renderModal()}</div>;
}
